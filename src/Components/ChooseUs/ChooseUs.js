...
const ChooseUs = () => {
    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2'>
            ...
            <div data-aos="fade-left" className='bg-black'>
                <div data-aos="fade-right" className="banner-content lg:pt-14 p-3 lg:p-5">
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-5'>
                        <div className='flex gap-3'>
                            <BiBus className='text-6xl font-bold text-orange-600'></BiBus>
            ...
            <div data-aos="fade-right" className='hidden lg:block p-2 bg-red-500 w-6/12 mt-[-170px] relative  z-20 rounded-lg lg:h-52 ml-5'>
